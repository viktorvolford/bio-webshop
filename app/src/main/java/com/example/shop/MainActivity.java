...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("248585328376-ou23v0v49k9t1goi6peabavi7i29hdr0.apps.googleusercontent.com")
                .requestEmail()
                .build();
    ...
    public void login(View view) {
        ...
        if(!email.isEmpty() && !password.isEmpty()) {
            ...
            Toast.makeText(this, "Ki kell töltened minden mezőt!", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void loginAsGuest(View view) {
        mAuth.signInAnonymously().addOnCompleteListener(this, task -> {
            if(task.isSuccessful()){
                ...
                Toast.makeText(MainActivity.this, "Anonymous user login failed: " + task.getException().getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
